...
// //           <Button 
// //             variant="outline" 
// //             className="bg-[#131a2b] border-gray-700 hover:bg-[#1c2539] text-gray-300 transition-all duration-300"
// //           >
// //             <ChevronLeft className="mr-2 h-4 w-4" />
// //             Back to Challenge Setup
// //           </Button>
...
// //         {/* User Profile Card */}
// //         <div className="bg-[#131a2b] border border-gray-800/50 rounded-lg p-6 mb-8 shadow-lg relative overflow-hidden">
// //           {/* Decorative elements */}
// //           <div className="absolute top-0 right-0 w-64 h-64 bg-purple-500/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-xl"></div>
// //           <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/5 rounded-full translate-y-1/2 -translate-x-1/2 blur-xl"></div>
          
// //           <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative z-10">
// //             <div className="relative">
// //               <Avatar className="w-24 h-24 bg-gradient-to-br from-purple-600 to-blue-600 text-white text-4xl border-4 border-[#0a0e17]">
// //                 <AvatarFallback className="bg-gradient-to-br from-purple-600 to-blue-600">U</AvatarFallback>
// //               </Avatar>
...
// //                 <div>
// //                   <h1 className="text-2xl font-bold mb-2 font-mono">User_1337</h1>
// //                   <div className="flex flex-wrap gap-2 mb-4">
// //                     <Badge className="bg-[#2b1d5a] text-purple-300 hover:bg-purple-700 flex items-center gap-1 rounded-full px-3">
// //                       <Award className="w-3 h-3" />
// //                       Level 5
// //                     </Badge>
// //                     <Badge className="bg-[#1d375a] text-blue-300 hover:bg-blue-700 flex items-center gap-1 rounded-full px-3">
// //                       <Trophy className="w-3 h-3" />
// //                       Rank #234
// //                     </Badge>
// //                     <Badge className="bg-[#1d5a29] text-green-300 hover:bg-green-700 flex items-center gap-1 rounded-full px-3">
// //                       <Code className="w-3 h-3" />
// //                       JavaScript
// //                     </Badge>
// //                     <Badge className="bg-[#5a3c1d] text-orange-300 hover:bg-orange-700 flex items-center gap-1 rounded-full px-3">
// //                       <Calendar className="w-3 h-3" />
// //                       Dec 2023
// //                     </Badge>
// //                   </div>
...
// //                 <button className="bg-blue-600 hover:bg-blue-700 text-white text-sm py-1.5 px-4 rounded font-mono flex items-center gap-2 transition-all duration-300">
...
// //                 <div className="text-sm font-semibold"><span className="text-blue-400">753</span>/1000</div>
// //               </div>
...
// //                   <div className="h-full bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center" style={{ width: '75%' }}>
// //                     <div className="w-full h-full bg-[url('data:image/svg+xml;base64,')]"></div>
// //                   </div>
// //                 </div>
...
// //         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
// //           {/* Activity Feed */}
// //           <div className="md:col-span-2 bg-[#131a2b] border border-gray-800/50 rounded-lg p-6 shadow-lg">
// //             <div className="flex items-center justify-between mb-6">
// //               <div className="flex items-center gap-2">
// //                 <Lightning className="w-5 h-5 text-blue-400" />
// //                 <h2 className="text-lg font-medium text-blue-400 font-mono">RECENT ACTIVITY</h2>
// //               </div>
...
// //                 title="Binary Search Implementation"
// //                 tags={[
// //                   { label: "Win", color: "bg-green-600 text-green-100" },
// //                   { label: "Intermediate", color: "bg-orange-700 text-orange-100" }
// //                 ]}
// //                 xp="+150 XP"
// //                 time="3 days ago"
// //               />
...
// //                 title="Reached Level 5"
// //                 tags={[
// //                   { label: "+200 XP", color: "bg-purple-700 text-purple-100" }
// //                 ]}
// //                 time="5 days ago"
// //               />
...
// //                 title="Linked List Reversal"
// //                 tags={[
// //                   { label: "Lost", color: "bg-red-700 text-red-100" },
// //                   { label: "Advanced", color: "bg-red-600 text-red-100" }
// //                 ]}
// //                 xp="+80 XP"
// //                 time="1 week ago"
// //               />
...
// //                 title="Earned Algorithm Master Badge"
// //                 tags={[
// //                   { label: "+60 XP", color: "bg-orange-700 text-orange-100" }
// //                 ]}
// //                 time="1 week ago"
// //               />
...
// //                 tags={[
// //                   { label: "Win", color: "bg-green-600 text-green-100" },
// //                   { label: "Beginner", color: "bg-blue-700 text-blue-100" }
// //                 ]}
// //                 xp="+100 XP"
// //                 time="2 weeks ago"
// //               />
...
// //           {/* Badges Progress */}
// //           <div className="bg-[#131a2b] border border-gray-800/50 rounded-lg p-6 shadow-lg">
...
// //         {/* Upcoming Challenges */}
// //         <div className="mt-8 bg-[#131a2b] border border-gray-800/50 rounded-lg p-6 shadow-lg">
// //           <div className="flex items-center justify-between mb-6">
// //             <div className="flex items-center gap-2">
// //               <Calendar className="w-5 h-5 text-green-400" />
// //               <h2 className="text-lg font-medium text-green-400 font-mono">UPCOMING TOURNAMENTS</h2>
// //             </div>
...
// //     switch(color) {
// //       case 'green': return 'from-[#1d2e20] to-[#1a291e]';
// //       case 'blue': return 'from-[#1d2a3e] to-[#1a2438]';
// //       case 'orange': return 'from-[#2e261d] to-[#29221a]';
// //       case 'purple': return 'from-[#2a1d3e] to-[#241a38]';
// //       default: return 'from-[#1d2a3e] to-[#1a2438]';
// //     }
// //   };
  
// //   const getBorderColor = (color) => {
// //     switch(color) {
// //       case 'green': return 'border-green-800/30';
// //       case 'blue': return 'border-blue-800/30';
// //       case 'orange': return 'border-orange-800/30';
// //       case 'purple': return 'border-purple-800/30';
...
// //   return (
// //     <div className={`bg-gradient-to-br ${getBgColor(color)} rounded-lg p-6 shadow-lg border ${getBorderColor(color)} flex flex-col justify-between h-full`}>
...
// //   return (
// //     <div className="bg-[#0d131f] rounded-lg p-4 flex items-start gap-4 border border-gray-800/20 hover:border-gray-700/30 transition-all duration-300">
// //       <div className={`
...
// //             </span>
// //           ))}
// //           {xp && <span className="bg-blue-700 text-blue-100 text-xs px-2 py-0.5 rounded-md font-mono">{xp}</span>}
// //         </div>
// //       </div>
...
// //   return (
// //     <div className="bg-[#0d131f] rounded-lg p-5 border border-gray-800/20 hover:border-gray-700/30 transition-all duration-300 relative overflow-hidden shadow-md">
// //       {/* Decorative accent */}
